...
public sealed partial class HomePage : Page
{
    ...
    // ===== 空岛卡片 3D 交互（对齐空岛安装器：鼠标跟随倾斜 + 辉光描边）=====
    public void CardFx_Enter(object sender, PointerRoutedEventArgs e) => Services.KdCardFx.Enter(sender, e);
    public void CardFx_Move(object sender, PointerRoutedEventArgs e) => Services.KdCardFx.Move(sender, e);
    public void CardFx_Exit(object sender, PointerRoutedEventArgs e) => Services.KdCardFx.Exit(sender, e);
